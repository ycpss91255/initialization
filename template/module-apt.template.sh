...
# module/<NAME>.module.sh — <one-line summary>  [archetype: apt]
#
# Authoring guide (doc/module-spec.md §3, §4; cookbook: doc/guide/archetype-cookbook.md):
#   1. cp template/module-apt.template.sh module/<your-name>.module.sh
#   2. Fill metadata (NAME / DESCRIPTION / CATEGORY / DEPENDS_ON / ...).
#   3. Fill APT_PKGS / APT_PPA / CONFIG_PATHS in the archetype block below.
...
APT_PKGS=()                                       # e.g. (curl ssh keychain)
