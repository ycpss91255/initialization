...
# module/<NAME>.module.sh — <one-line summary>  [archetype: config]
#
# Authoring guide (doc/module-spec.md §3, §4; cookbook: doc/guide/archetype-cookbook.md):
#   1. cp template/module-config.template.sh module/<your-name>.module.sh
...
CONFIG_TEMPLATE_SRC="<TODO: ${MODULE_DIR}/config/<tool>/<file>>"
CONFIG_DEST="<TODO: ${HOME}/.config/<tool>/<file>>"
